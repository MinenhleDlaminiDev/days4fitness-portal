...
export function XCircleIcon({ size, className = "" }) {
  return (
    <svg {...iconProps(size)} className={className}>
      <circle cx="12" cy="12" r="10" />
...
export function AlertCircleIcon({ size, className = "" }) {
  return (
    <svg {...iconProps(size)} className={className}>
      <circle cx="12" cy="12" r="10" />
...
export function PhoneIcon({ size, className = "" }) {
  return (
    <svg {...iconProps(size)} className={className}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.32 1.8.58 2.65a2 2 0 0 1-.45 2.11L8 9.99a16 16 0 0 0 6 6l1.51-1.24a2 2 0 0 1 2.11-.45c.85.26 1.75.46 2.65.58A2 2 0 0 1 22 16.92z" />
    </svg>
  );
}
